...
const pessoa = {
    ...
    idade: 30,
    solteiro: true,
    hobbies: ["Cozinhar", "Pescar"],
    mostrarInfoPessoa: function () {
        console.log(`
            nome: ${this.nome} | ${typeof(this.nome)}
            idade: ${this.idade} | ${typeof(this.idade)}
            nome: ${this.solteiro} | ${typeof(this.solteiro)}
            hobbies: ${this.hobbies} | ${typeof(this.hobbies)}
        `)
    }
}
